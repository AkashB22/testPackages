...
async function main(callback){
    try {
        ...
        allFiles = allFiles.concat(getAllVideo).concat(documents).concat(thumbnails);

        console.log(`Video files available - ${videos.length}, Videos with transcoded files - ${getAllVideo.length}, Document files available - ${documents.length}, Thumbnail files available - ${thumbnails.length}, So the Total files are - ${allFiles.length}`);
